package com.mac.runtu.ipcamer.adapter;
...
public class SearchListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			//convertView = listContainer.inflate(layout.search_list_item, null);
			//searchListItem.devName = (TextView)convertView.findViewById(id.searchDevName) ;
			//searchListItem.devID = (TextView)convertView.findViewById(id.searchDevID) ;
...
//		}else{
//		}
	//	convertView.setBackgroundResource(drawable.listitem_pressed_selector);
		if(listItems != null)
		{
